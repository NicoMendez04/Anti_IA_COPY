...
export function examRecord(session) {
  ...
  return {
    ...
    courseSemester: session.courseSemester ?? null,
    courseCategory: session.courseCategory ?? null,
    specialtyIds: session.specialtyIds ?? [],
    specialtyNames: session.specialtyNames ?? [],
